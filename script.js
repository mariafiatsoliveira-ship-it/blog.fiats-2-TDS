...
artigos.forEach(function (artigo) {
    const btnLike = article.querySelector(".btn-like") || artigo.querySelector(".btn-like");
    const btnDislike = article.querySelector(".btn-dislike") || artigo.querySelector(".btn-dislike");
